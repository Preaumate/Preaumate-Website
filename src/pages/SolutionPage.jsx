...
import { ArrowRight, ArrowLeft, CheckCircle, Cpu, Monitor, RefreshCw, Shield, Briefcase, Sparkles } from 'lucide-react';
...
const SolutionPage = () => {
  ...
  if (!solution) { navigate('/'); return null; }
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <div className="flex items-center gap-4 mb-6">
                <div
                  ...
                  style={{ background: solution.bg, border: `1px solid ${solution.color}40` }}
                >
                  <Icon className="w-7 h-7" style={{ color: solution.color }} />
                </div>
                <span
                  className="text-xs font-bold tracking-widest px-4 py-1.5 rounded-full"
                  style={{ background: solution.bg, border: `1px solid ${solution.color}40`, color: solution.color }}
                >
                  PREAUMATE SOLUTIONS
                </span>
              </div>
              ...
              <p className="text-xl leading-relaxed max-w-2xl font-medium" style={{ color: solution.color }}>
                {content.tagline}
              </p>
          ...
          <div className="w-full overflow-hidden" style={{ maxHeight: '480px' }}>
            ...
            {solution.images[0].caption && (
              <p
                ...
                style={{ background: '#1e293b', color: '#64748b', borderBottom: '1px solid rgba(16,185,129,0.1)' }}
              >
                {solution.images[0].caption}
              </p>
            )}
            ...
            <div className="container mx-auto px-6 max-w-4xl pt-8">
              ...
              >
                ...
                {solution.images[1].caption && (
                  <p className="text-sm py-3 px-5" style={{ background: '#0f172a', color: '#64748b' }}>
                    {solution.images[1].caption}
                  </p>
                )}
              </motion.div>
        ...
        <section className="py-20" style={{ background: '#1e293b' }}>
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-black" style={{ color: '#f0f4ff' }}>
              ...
              {content.deliverables.map((item, i) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-base mb-2" style={{ color: '#f0f4ff' }}>{item.title}</h3>
        ...
        <section className="py-20" style={{ background: '#020818' }}>
          <div className="container mx-auto px-6 max-w-3xl text-center">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-4xl font-black mb-4" style={{ color: '#f0f4ff' }}>{cta.title}</h2>
              <p className="text-lg mb-8" style={{ color: '#94a3b8' }}>{cta.subtitle}</p>
              <Link
                to="/#contact"
