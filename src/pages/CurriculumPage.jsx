...
import {
  Phone, Mail, Linkedin, MapPin, ArrowRight,
  CheckCircle2, GraduationCap, Award, Globe,
  Briefcase, ChevronRight, Menu, X, Share2,
} from 'lucide-react';
...
const ROLE_ACCENTS = [
  ...
  { color: PURPLE, bg: 'rgba(139,92,246,0.1)',  border: 'rgba(139,92,246,0.25)'  },
...
const Divider = ({ from, to }) => (
  <div style={{ height: '56px', background: `linear-gradient(to bottom, ${from}, ${to})` }} />
);
  ...
  if (!cv) return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: DARK }}>
      <p className="text-sm" style={{ color: MUTED }}>
        Add "curriculum" to translations.json then run: python i18n_tools.py build
      </p>
    </div>
  );
    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: DARK }}>
        ...
        <div
          ...
          style={{ background: 'linear-gradient(135deg, #020818 0%, #0c1a30 40%, #0f2a1a 100%)' }}
        >
          <div
          ...
          <div className="container mx-auto px-6 max-w-5xl relative z-10">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
              ...
              >
                ...
                <h1 className="text-4xl md:text-5xl font-black mb-1 leading-tight" style={{ color: TEXT }}>
                  {data.name}
                </h1>
                <p className="text-lg md:text-xl font-semibold mb-3" style={{ color: GREEN }}>
                  {cv.heroSubtitle}
                </p>
                <p className="text-base leading-relaxed mb-5 max-w-xl" style={{ color: MUTED }}>
                  {cv.heroTagline}
                </p>
                {/* Contact strip */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="lg:col-span-1 flex flex-col gap-6 lg:sticky lg:top-24">
                ...
                <motion.div
                  ...
                  style={{ background: CARD, border: `1px solid rgba(16,185,129,0.2)` }}
                >
                  {/* Nav header */}
                  <div
                  ...
                  >
                    ...
                    <span className="text-xs font-black tracking-widest" style={{ color: GREEN }}>
                      SECTIONS
                    </span>
                  </div>
                  ...
                  >
                    <button
                      ...
                      style={{
                        background: copied ? 'rgba(16,185,129,0.2)' : 'rgba(16,185,129,0.06)',
                    ...
                    <p className="text-xs mt-2 leading-relaxed" style={{ color: FAINT }}>
                ...
                <motion.div
                  ...
                  style={{ background: CARD, border: `1px solid rgba(16,185,129,0.15)` }}
                >
                  <SectionBadge>{cv.skillsBadge}</SectionBadge>
                  <h3 className="text-base font-bold mb-4" style={{ color: TEXT }}>
                    {cv.skillsTitle}
                  </h3>
                ...
                <motion.div
                  ...
                  className="rounded-2xl p-6"
                  style={{ background: CARD, border: `1px solid rgba(14,165,233,0.15)` }}
                >
                  <div className="flex items-center gap-2 mb-4">
                    <Globe className="w-4 h-4" style={{ color: BLUE }} />
                    <span className="text-xs font-black tracking-widest" style={{ color: BLUE }}>
                      {cv.languagesBadge}
                    </span>
                  </div>
                  <div className="space-y-3">
                    {data.spokenLanguages.map(({ langKey, flag }) => {
                      ...
                      if (!lang) return null;
                      return (
                        <div key={langKey} className="flex items-center justify-between">
                ...
                <motion.div
                  ...
                  className="rounded-2xl p-6"
                  style={{ background: CARD, border: `1px solid rgba(139,92,246,0.15)` }}
                >
                  <div className="flex items-center gap-2 mb-4">
                    <GraduationCap className="w-4 h-4" style={{ color: PURPLE }} />
                    <span className="text-xs font-black tracking-widest" style={{ color: PURPLE }}>
                      {cv.educationBadge}
                    </span>
                  </div>
                  <p className="text-sm font-bold leading-snug mb-1" style={{ color: TEXT }}>
                    {cv.degreeTitle}
                  </p>
                  <p className="text-xs font-medium mb-0.5" style={{ color: PURPLE }}>
                ...
                <motion.div
                  ...
                  className="rounded-2xl p-6"
                  style={{ background: CARD, border: `1px solid rgba(245,158,11,0.15)` }}
                >
                  <div className="flex items-center gap-2 mb-4">
                    <Award className="w-4 h-4" style={{ color: AMBER }} />
                    <span className="text-xs font-black tracking-widest" style={{ color: AMBER }}>
                  ...
                  <div className="space-y-4">
                    {data.certifications.map(({ certKey }) => {
                      ...
                      return (
                        <div key={certKey}>
                          <p className="text-sm font-bold leading-snug mb-0.5" style={{ color: TEXT }}>
                            {cert.title}
                          </p>
              ...
              <div className="lg:col-span-2 flex flex-col gap-8">
                ...
                <section id="experience" className="scroll-mt-28">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-center flex-shrink-0 pt-1">
                              ...
                              >
                                <ChevronRight
                                  className="w-4 h-4"
                                  style={{ color: role.current ? '#020818' : accent.color }}
                                />
                              </div>
                            </div>
                            {/* Card */}
                            ...
                            >
                              <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                                <div>
                                  ...
                                  <p className="text-sm font-semibold mt-0.5" style={{ color: accent.color }}>
                                    {role.company}
                                  </p>
                                </div>
                                <div className="text-right flex-shrink-0">
                                  <p className="text-xs font-medium" style={{ color: FAINT }}>{role.period}</p>
                                  <p className="text-xs" style={{ color: FAINT }}>{role.location}</p>
                                </div>
                              </div>
                  ...
                  <motion.div
                    ...
                    style={{ background: CARD, border: '1px solid rgba(100,116,139,0.2)' }}
                  >
                    <SectionBadge color={FAINT}>{cv.earlierCareerBadge}</SectionBadge>
                    <div className="divide-y" style={{ borderColor: 'rgba(100,116,139,0.1)' }}>
                      {data.earlierRoles.map((r, i) => (
                        <div key={i} className="py-3 flex justify-between items-start gap-4">
                          <div>
                            <p className="text-sm font-semibold" style={{ color: MUTED }}>{r.role}</p>
                            <p className="text-xs" style={{ color: FAINT }}>{r.company} · {r.location}</p>
                          </div>
                          <span className="text-xs flex-shrink-0" style={{ color: FAINT }}>{r.period}</span>
                        </div>
                      ))}
                    </div>
                  </motion.div>
        ...
        ══════════════════════════════════════════════════ */}
        <section id="technical" className="py-16 scroll-mt-24" style={{ background: DARK }}>
          <div className="container mx-auto px-6 max-w-5xl">
                ...
                return (
                  ...
                  >
                    <div className="px-4 py-2.5" style={{ background: c.bg }}>
                      <p className="text-xs font-black tracking-widest uppercase" style={{ color: c.color }}>
                    ...
                    <div className="p-4 space-y-2" style={{ background: CARD }}>
                      {items.map((item, ii) => (
                        <div key={ii} className="flex items-center gap-2">
                          ...
                          />
                          <span className="text-xs font-medium" style={{ color: MUTED }}>{item}</span>
                        </div>
                      ))}
                    </div>
                  </motion.div>
        ...
        ══════════════════════════════════════════════════ */}
        <section id="contact-cv" className="py-20 scroll-mt-24" style={{ background: LIGHT }}>
          <div className="container mx-auto px-6 max-w-2xl text-center">
            ...
            >
              ...
              <Link
                ...
                onMouseEnter={(e) => (e.currentTarget.style.boxShadow = '0 0 45px rgba(16,185,129,0.5)')}
