          ...
          <div className="container mx-auto px-6 py-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                ...
                {/* ── COOKIE POLICY LINK ──────────────────────────────────
                    TODO: Create /cookie-policy page then restore this link.
                    Until then, points to privacy-policy which covers cookies.
                ───────────────────────────────────────────────────────── */}
                {/* ORIGINAL — restore when /cookie-policy page exists:
                <Link
                  to="/cookie-policy"
                  className="text-emerald-400 hover:text-emerald-300 underline"
                >
                ...
                */}
                ...
                {/* TEMPORARY — points to privacy policy: */}
                <Link
                  to="/privacy-policy"
                  className="text-emerald-400 hover:text-emerald-300 underline"
                >
